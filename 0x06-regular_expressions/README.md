...
This project examines a very powerful tool in word or text processing called regular expressions shortened as regexp. It was also built using oniguruma library.
